...
const Categories = () => {
  ...
  return (
    <div className='max-w-6xl mx-auto bg-gradient-to-br from-black via-gray-900 to-black w-full overflow-hidden rounded-2xl shadow-2xl my-8'>
      <Link to="/BoomBox">
      <div 
        ...
        >
          ...
          >
            ...
            <div className='w-full relative'>
              ...
              />
              {/* Animated circles behind speaker */}
